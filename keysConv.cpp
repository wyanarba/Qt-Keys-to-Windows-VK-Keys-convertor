...
KeysConvector::KeysConvector() {
    ...
    // Fujitsu/OASYS kbd --------------------
//{Qt::Key_Jisho,  146},  //0x92   VK_OEM_FJ_JISHO     | 'Dictionary' key /
...
{ Qt::Key_MediaPrevious, 177 }, //177 0xB1   VK_MEDIA_PREV_TRACK | Previous Track key
{Qt::Key_MediaStop, 178},  //0xB2   VK_MEDIA_STOP       | Stop Media key
{Qt::Key_MediaTogglePlayPause, 179},  //0xB3   VK_MEDIA_PLAY_PAUSE | Play/Pause Media key
...
{Qt::Key_Equal, 187},  //0xBB   VK_OEM_PLUS         | '+' any country
...
{Qt::Key_unknown, 223},  //0xDF   VK_OEM_8
...
{Qt::Key_Clear,   254}  //0xFE   VK_OEM_CLEAR        | Clear key
    ...
    for (const auto& pair : QKeyToSysKey) {
        SysKeyToQKey[pair.second] = pair.first;
    }
}